...
interface IStoreProps {
    ...
    configsList?: IConfig2Store.IConfig[]
...
@inject(
    (store: IStore): IStoreProps => {
        const { routerStore, config2Store } = store
        const {
            getConfigLoading,
            configsList,
            getConfigsList,
...
class ConfigTable extends ComponentExt<IProps> {
    ...
    @observable
    private targetConfig: IConfig2Store.IConfig = {}

    // get targetConfig(): IConfig2Store.IConfig {
    ...
    handelOk = (data) => {
        ...
        switch (this.modelType) {
            ...
            case 'add':
                ...
                this.props.routerStore.push(`/config2/add`)
                break;
        }
    ...
    @action
    viewModel(type: useType, config?: IConfig2Store.IConfig) {
        this.modelType = type;
    ...
    goEdit(id, query?) {
        this.props.routerStore.push(`/config2/edit/${id}` + (query || ''))
    }
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                >
                    <Table.Column<IConfig2Store.IConfig> key="pkg_name" title="Pkg Name" dataIndex="pkg_name" width={200} />
                    <Table.Column<IConfig2Store.IConfig> key="bundle_id" title="Bundle ID" dataIndex="bundle_id" width={200} />
                    <Table.Column<IConfig2Store.IConfig> key="platform" title="Platform" dataIndex="platform" width={200} />
                    <Table.Column<IConfig2Store.IConfig>
                        key="totalConfig"
