    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <Table.Column<IAppManageStore.IAppMange> key="BD" title="BD" dataIndex="BD" width={100} />
                <Table.Column<IAppManageStore.IAppMange> key="AM" title="AM" dataIndex="AM" width={100} />
